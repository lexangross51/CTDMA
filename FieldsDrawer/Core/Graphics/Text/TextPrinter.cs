...
namespace FieldsDrawer.Core.Graphics.Text;
...
public static class TextPrinter
{
    ...
    private static BicubicHermite.Core.Graphics.Texture.Texture? _texture;
        ...
        SharpPlotFont font, TextOrientation orientation = TextOrientation.Horizontal)
    {
        ...
        _texture = new BicubicHermite.Core.Graphics.Texture.Texture(textImage);
        textImage.Dispose();
