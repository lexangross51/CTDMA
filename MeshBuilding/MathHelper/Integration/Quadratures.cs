namespace MeshBuilding.MathHelper.Integration;

public struct QuadratureNode<T> where T : notnull
{
    public T Node { get; }
...
{
    public IReadOnlyCollection<QuadratureNode<T>> Nodes { get; }

    public Quadrature(IReadOnlyCollection<QuadratureNode<T>> nodes)
    {
        Nodes = nodes;
    }
}
